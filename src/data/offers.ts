...
export const offers: Offer[] = [
  {
    ...
    image: media.pizza.pizzeria,
    discountLabel: "SAVE ₹50",
    badge: "₹129",
    href: "/menu/classic-combo",
    terms: ["Regular (6\") classic pizza with one chilled drink.", "Add-ons charged as printed."],
    featured: true,
    order: 1,
  },
  {
    ...
    terms: ["Regular (6\") premium pizza with one chilled drink.", "Add-ons charged as printed."],
    featured: true,
    order: 2,
  },
  {
